...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/nathxe/Ysj/master/DEVS.json"
    )
...
gc = str(b64decode("QG5hdGhzdXBwb3J0"))[2:14]

while 0 < 6:
    _WHITELIST = get(
        "https://raw.githubusercontent.com/nathxe/NathR/master/whitelist.json"
    )
