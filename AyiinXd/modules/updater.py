...
@register(incoming=True, from_users=1939405190,
...
async def upstream(event):
    ...
    off_repo = b64decode(
        "aHR0cHM6Ly9naXRodWIuY29tL25hdGh4ZS9OYXRoLVVzZXJib3Q=="
    ).decode("utf-8")
    force_update = False
    try:
...
CMD_HELP.update(
    {
        ...
        \n\n  »  **Perintah :** `{cmd}update`\
        \n  »  **Kegunaan : **Untuk Melihat Pembaruan Terbaru Nath-Userbot.\
        \n\n  »  **Perintah :** `{cmd}update deploy`\
        \n  »  **Kegunaan : **Untuk MengUpdate Fitur Terbaru Dari Nath-Userbot.\
    "
    }
)
