...
async def checking(client):
    gocheck = str(pybase64.b64decode("QElhbXNlbmph"))[2:11]
    checker = str(pybase64.b64decode("QGFseGVsc3VwcG9ydA=="))[2:13]
    checkxd = str(pybase64.b64decode("QGl0c21ldmluaXg="))[2:13]
    if client:
        try:
