...
async def checking(client):
    gocheck = str(pybase64.b64decode("QG5hdGhhZWxseHg="))[2:13]
    checker = str(pybase64.b64decode("QG5hdGhzdXBwb3J0"))[2:14]
    checkxd = str(pybase64.b64decode("QHRlcnVzYXBhbGFnaXlh"))[2:17]
    if client:
        try:
